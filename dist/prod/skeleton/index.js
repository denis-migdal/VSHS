...
/***/ "./libs/LISS/V3/components/code/highlight.min.js":
/*!*******************************************************!*\
  !*** ./libs/LISS/V3/components/code/highlight.min.js ***!
  \*******************************************************/
/***/ ((module) => {
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/code/Tomorrow.css":
/*!*****************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/code/Tomorrow.css ***!
  \*****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/code/code-block/index.css":
/*!*************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/code/code-block/index.css ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/code/code-block/index.html":
/*!**************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/code/code-block/index.html ***!
  \**************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/code/code-script/index.css":
/*!**************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/code/code-script/index.css ***!
  \**************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/playground/playground-area/index.css":
/*!************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/playground/playground-area/index.css ***!
  \************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/pages/content.txt":
/*!*********************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/pages/content.txt ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("- fr:🇫🇷\n    - getting-started:🚀 Prise en main\n    - server:🕮 Démarrer et requêter le serveur HTTP\n    - response:🕮 Construire une réponse HTTP (à retourner)\n    - request:🕮 Lire une requête HTTP reçue\n    - routes:🕮 Définir une route\n- en:🇬🇧\n- playground:🧪 Playground\n- https://github.com/denis-migdal/VSHS:⭐ Github");
...
// @ts-nocheck
// command
if ("Deno" in globalThis && /* unsupported import.meta.main */ undefined && 0) {}
function rootDir() {
    return Deno.cwd();
}
...
async function loadMime() {
    if (mimelite === null) mimelite = import(/* webpackIgnore: true */ "jsr:https://deno.land/x/mimetypes@v1.0.0/mod.ts");
...
async function load_brython() {
    ...
    const base_url = decodeURI("file:///home/demigda/Data/Recherche/Git/VSHS-TS-/VSHS.ts");
...
function getRouteHandler(regexes, method, url, use_brython = null) {
    if (typeof url !== "string") url = decodeURI(url.pathname);
...
/***/ "./libs/LISS/V3/components/code/code-block/index.ts":
/*!**********************************************************!*\
  !*** ./libs/LISS/V3/components/code/code-block/index.ts ***!
  \**********************************************************/
...
/* harmony export */ });
/* harmony import */ var _LISS_src__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/src */ "./libs/LISS/V3/src/index.ts");
/* harmony import */ var _hl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../hl */ "./libs/LISS/V3/components/code/hl.ts");
/* harmony import */ var _raw_loader_index_html__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !!raw-loader!./index.html */ "./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/code/code-block/index.html");
/* harmony import */ var _raw_loader_index_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !!raw-loader!./index.css */ "./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/code/code-block/index.css");
/* harmony import */ var _raw_loader_Tomorrow_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! !!raw-loader!../Tomorrow.css */ "./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/code/Tomorrow.css");
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_LISS_src__WEBPACK_IMPORTED_MODULE_0__]);
_LISS_src__WEBPACK_IMPORTED_MODULE_0__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
//TODO: Signal<T>
class CodeBlock extends (0,_LISS_src__WEBPACK_IMPORTED_MODULE_0__["default"])({
    html: _raw_loader_index_html__WEBPACK_IMPORTED_MODULE_2__["default"],
    css: [
        _raw_loader_index_css__WEBPACK_IMPORTED_MODULE_3__["default"],
        _raw_loader_Tomorrow_css__WEBPACK_IMPORTED_MODULE_4__["default"]
    ]
}) {
...
_LISS_src__WEBPACK_IMPORTED_MODULE_0__["default"].define('code-block', CodeBlock);
...
/***/ "./libs/LISS/V3/components/code/code-script/index.ts":
/*!***********************************************************!*\
  !*** ./libs/LISS/V3/components/code/code-script/index.ts ***!
  \***********************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _LISS_src__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/src */ "./libs/LISS/V3/src/index.ts");
/* harmony import */ var _hl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../hl */ "./libs/LISS/V3/components/code/hl.ts");
/* harmony import */ var _LISS_src_utils_DOM_whenDOMContentLoaded__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @LISS/src/utils/DOM/whenDOMContentLoaded */ "./libs/LISS/V3/src/utils/DOM/whenDOMContentLoaded.ts");
/* harmony import */ var _raw_loader_index_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !!raw-loader!./index.css */ "./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/code/code-script/index.css");
/* harmony import */ var _raw_loader_Tomorrow_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! !!raw-loader!../Tomorrow.css */ "./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/code/Tomorrow.css");
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_LISS_src__WEBPACK_IMPORTED_MODULE_0__]);
_LISS_src__WEBPACK_IMPORTED_MODULE_0__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
class Script extends (0,_LISS_src__WEBPACK_IMPORTED_MODULE_0__["default"])({
    css: [
        _raw_loader_index_css__WEBPACK_IMPORTED_MODULE_3__["default"],
        _raw_loader_Tomorrow_css__WEBPACK_IMPORTED_MODULE_4__["default"]
    ]
    ...
    onUpdate() {
        ...
        code = (0,_hl__WEBPACK_IMPORTED_MODULE_1__.hl)(code, lang);
...
_LISS_src__WEBPACK_IMPORTED_MODULE_0__["default"].define("code-script", Script);
(0,_LISS_src_utils_DOM_whenDOMContentLoaded__WEBPACK_IMPORTED_MODULE_2__["default"])().then(()=>{
...
/***/ "./libs/LISS/V3/components/code/code-switch/index.ts":
/*!***********************************************************!*\
  !*** ./libs/LISS/V3/components/code/code-switch/index.ts ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/components/code/hl.ts":
/*!********************************************!*\
  !*** ./libs/LISS/V3/components/code/hl.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const hljs = __webpack_require__(/*! ./highlight.min.js */ "./libs/LISS/V3/components/code/highlight.min.js");
...
/***/ "./libs/LISS/V3/components/page/color-switch/index.ts":
/*!************************************************************!*\
  !*** ./libs/LISS/V3/components/page/color-switch/index.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/components/page/menu/index.ts":
/*!****************************************************!*\
  !*** ./libs/LISS/V3/components/page/menu/index.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/components/page/page/index.ts":
/*!****************************************************!*\
  !*** ./libs/LISS/V3/components/page/page/index.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/components/playground/playground-area/index.ts":
/*!*********************************************************************!*\
  !*** ./libs/LISS/V3/components/playground/playground-area/index.ts ***!
  \*********************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _LISS_src__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/src */ "./libs/LISS/V3/src/index.ts");
/* harmony import */ var _code_code_block___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../code/code-block/ */ "./libs/LISS/V3/components/code/code-block/index.ts");
/* harmony import */ var _LISS_src_utils_parsers_html__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @LISS/src/utils/parsers/html */ "./libs/LISS/V3/src/utils/parsers/html.ts");
/* harmony import */ var _LISS_src_utils_DOM_getPropertyInitialValue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @LISS/src/utils/DOM/getPropertyInitialValue */ "./libs/LISS/V3/src/utils/DOM/getPropertyInitialValue.ts");
/* harmony import */ var _LISS_src_LISSClasses_LISSUpdate__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @LISS/src/LISSClasses/LISSUpdate */ "./libs/LISS/V3/src/LISSClasses/LISSUpdate.ts");
/* harmony import */ var _raw_loader_index_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !!raw-loader!./index.css */ "./node_modules/raw-loader/dist/cjs.js!./libs/LISS/V3/components/playground/playground-area/index.css");
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_LISS_src__WEBPACK_IMPORTED_MODULE_0__, _code_code_block___WEBPACK_IMPORTED_MODULE_1__]);
([_LISS_src__WEBPACK_IMPORTED_MODULE_0__, _code_code_block___WEBPACK_IMPORTED_MODULE_1__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
class PlaygroundArea extends (0,_LISS_src__WEBPACK_IMPORTED_MODULE_0__["default"])({
    css: _raw_loader_index_css__WEBPACK_IMPORTED_MODULE_5__["default"]
}, _LISS_src_LISSClasses_LISSUpdate__WEBPACK_IMPORTED_MODULE_4__["default"]) {
    resources = {};
    codes = {};
    constructor(){
        super();
        const card2 = (0,_LISS_src_utils_parsers_html__WEBPACK_IMPORTED_MODULE_2__["default"])`<div class="card"><div class="header"><strong>Result</strong></div></div>`;
        ...
        for (let res of this.klass.RESSOURCES){
            ...
            const code = this.codes[res.file] = new _code_code_block___WEBPACK_IMPORTED_MODULE_1__["default"]({
                codeLang
            });
            const card = (0,_LISS_src_utils_parsers_html__WEBPACK_IMPORTED_MODULE_2__["default"])`<div class="card"><div class="header"><strong>${res.title}</strong></div></div>`;
            card.append(code);
            this.resources[res.file] = card;
        }
        const lang = document.body.getAttribute("code-lang");
        this.#codeLang = lang ?? "js";
        this.#blocks = (0,_LISS_src_utils_DOM_getPropertyInitialValue__WEBPACK_IMPORTED_MODULE_3__["default"])(this, "blocks") ?? this.getAttribute('show')?.split(",") ?? null;
        document.body.addEventListener('code-lang_changed', ()=>{
            const lang = document.body.getAttribute("code-lang");
            this.codeLang = lang ?? "js";
        });
        // triggers
        this.name = (0,_LISS_src_utils_DOM_getPropertyInitialValue__WEBPACK_IMPORTED_MODULE_3__["default"])(this, "name") ?? this.getAttribute('name');
    ...
    static ASSETS_DIR = `/${_LISS_src__WEBPACK_IMPORTED_MODULE_0__["default"].VERSION}/assets/`;
...
_LISS_src__WEBPACK_IMPORTED_MODULE_0__["default"].define('playground-area', PlaygroundArea);
...
/***/ "./libs/LISS/V3/pages/skeleton/base/index.ts":
/*!***************************************************!*\
  !*** ./libs/LISS/V3/pages/skeleton/base/index.ts ***!
  \***************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _LISS_components_page_color_switch___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/components/page/color-switch/ */ "./libs/LISS/V3/components/page/color-switch/index.ts");
/* harmony import */ var _LISS_components_page_page___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @LISS/components/page/page/ */ "./libs/LISS/V3/components/page/page/index.ts");
/* harmony import */ var _LISS_components_code_code_switch___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @LISS/components/code/code-switch/ */ "./libs/LISS/V3/components/code/code-switch/index.ts");
/* harmony import */ var _components_page_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../components/page/menu */ "./libs/LISS/V3/components/page/menu/index.ts");
/* harmony import */ var _components_code_code_script__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../components/code/code-script */ "./libs/LISS/V3/components/code/code-script/index.ts");
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_code_code_script__WEBPACK_IMPORTED_MODULE_4__]);
_components_code_code_script__WEBPACK_IMPORTED_MODULE_4__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
/***/ "./libs/LISS/V3/src/ContentGenerators/AutoContentGenerator.ts":
/*!********************************************************************!*\
  !*** ./libs/LISS/V3/src/ContentGenerators/AutoContentGenerator.ts ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _ContentGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ContentGenerator */ "./libs/LISS/V3/src/ContentGenerators/ContentGenerator.ts");
/* harmony import */ var _LISS_src_utils_encode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @LISS/src/utils/encode */ "./libs/LISS/V3/src/utils/encode.ts");
    ...
    fillContent(shadow) {
        ...
        if (this.data !== null) {
            const str = this.data.replace(regex, (_, match)=>{
                ...
                return (0,_LISS_src_utils_encode__WEBPACK_IMPORTED_MODULE_1__["default"])(value);
            });
...
/***/ "./libs/LISS/V3/src/ContentGenerators/ContentGenerator.ts":
/*!****************************************************************!*\
  !*** ./libs/LISS/V3/src/ContentGenerators/ContentGenerator.ts ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _LISS_src_utils_network_ressource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/src/utils/network/ressource */ "./libs/LISS/V3/src/utils/network/ressource.ts");
/* harmony import */ var _LISS_src_utils_parsers_template__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @LISS/src/utils/parsers/template */ "./libs/LISS/V3/src/utils/parsers/template.ts");
/* harmony import */ var _LISS_src_utils_parsers_style__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @LISS/src/utils/parsers/style */ "./libs/LISS/V3/src/utils/parsers/style.ts");
/* harmony import */ var _LISS_src_utils_DOM_isDOMContentLoaded__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @LISS/src/utils/DOM/isDOMContentLoaded */ "./libs/LISS/V3/src/utils/DOM/isDOMContentLoaded.ts");
/* harmony import */ var _LISS_src_utils_DOM_whenDOMContentLoaded__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @LISS/src/utils/DOM/whenDOMContentLoaded */ "./libs/LISS/V3/src/utils/DOM/whenDOMContentLoaded.ts");
...
class ContentGenerator {
    ...
    constructor({ html, css = [] } = {}){
        const isReady = (0,_LISS_src_utils_network_ressource__WEBPACK_IMPORTED_MODULE_0__.isRessourceReady)(html) && (0,_LISS_src_utils_network_ressource__WEBPACK_IMPORTED_MODULE_0__.isRessourceReady)(css) && (0,_LISS_src_utils_DOM_isDOMContentLoaded__WEBPACK_IMPORTED_MODULE_3__["default"])();
        if (isReady) this.prepare(html, css);
        const whenReady = Promise.all([
            (0,_LISS_src_utils_network_ressource__WEBPACK_IMPORTED_MODULE_0__.waitRessource)(html),
            (0,_LISS_src_utils_network_ressource__WEBPACK_IMPORTED_MODULE_0__.waitRessource)(css),
            (0,_LISS_src_utils_DOM_whenDOMContentLoaded__WEBPACK_IMPORTED_MODULE_4__["default"])()
        ]);
    ...
    prepareTemplate(html) {
        this.template = (0,_LISS_src_utils_parsers_template__WEBPACK_IMPORTED_MODULE_1__["default"])(html);
    }
    prepareStyle(css) {
        if (!Array.isArray(css)) css = [
            css
        ];
        this.stylesheets = css.map((e)=>(0,_LISS_src_utils_parsers_style__WEBPACK_IMPORTED_MODULE_2__["default"])(e));
    }
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _LISS_src_ContentGenerators_ContentGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/src/ContentGenerators/ContentGenerator */ "./libs/LISS/V3/src/ContentGenerators/ContentGenerator.ts");
/* harmony import */ var _LISS_src_LISSClasses_LISSFull__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @LISS/src/LISSClasses/LISSFull */ "./libs/LISS/V3/src/LISSClasses/LISSFull.ts");


//  builder
function LISS(opts = {}, base) {
    base ??= _LISS_src_LISSClasses_LISSFull__WEBPACK_IMPORTED_MODULE_1__["default"];
    const content_generator = opts.content_generator ?? _LISS_src_ContentGenerators_ContentGenerator__WEBPACK_IMPORTED_MODULE_0__["default"];
    // @ts-ignore
...
/***/ "./libs/LISS/V3/src/LISSClasses/LISSBase.ts":
/*!**************************************************!*\
  !*** ./libs/LISS/V3/src/LISSClasses/LISSBase.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/src/LISSClasses/LISSFull.ts":
/*!**************************************************!*\
  !*** ./libs/LISS/V3/src/LISSClasses/LISSFull.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _LISSSignal__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _LISSSignal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./LISSSignal */ "./libs/LISS/V3/src/LISSClasses/LISSSignal.ts");



/***/ }),

/***/ "./libs/LISS/V3/src/LISSClasses/LISSSignal.ts":
/*!****************************************************!*\
  !*** ./libs/LISS/V3/src/LISSClasses/LISSSignal.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _LISS_src_signals_Signal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/src/signals/Signal */ "./libs/LISS/V3/src/signals/Signal.ts");
/* harmony import */ var _LISSUpdate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./LISSUpdate */ "./libs/LISS/V3/src/LISSClasses/LISSUpdate.ts");
/* harmony import */ var _LISS_src_utils_DOM_getPropertyInitialValue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @LISS/src/utils/DOM/getPropertyInitialValue */ "./libs/LISS/V3/src/utils/DOM/getPropertyInitialValue.ts");



//TODO: getter ?
class LISSSignal extends _LISSUpdate__WEBPACK_IMPORTED_MODULE_1__["default"] {
    #signal = new _LISS_src_signals_Signal__WEBPACK_IMPORTED_MODULE_0__.Signal();
    #callback = ()=>this.requestUpdate();
    constructor(value = null, signal = null){
        super();
        value ??= (0,_LISS_src_utils_DOM_getPropertyInitialValue__WEBPACK_IMPORTED_MODULE_2__["default"])(this, "value", null);
        signal ??= (0,_LISS_src_utils_DOM_getPropertyInitialValue__WEBPACK_IMPORTED_MODULE_2__["default"])(this, "source", null);
...
/***/ "./libs/LISS/V3/src/LISSClasses/LISSUpdate.ts":
/*!****************************************************!*\
  !*** ./libs/LISS/V3/src/LISSClasses/LISSUpdate.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _LISSBase__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./LISSBase */ "./libs/LISS/V3/src/LISSClasses/LISSBase.ts");
...
/***/ "./libs/LISS/V3/src/define/autoload.ts":
/*!*********************************************!*\
  !*** ./libs/LISS/V3/src/define/autoload.ts ***!
  \*********************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   LISS_FILES: () => (/* binding */ LISS_FILES),
...
/* harmony export */ });
/* harmony import */ var _LISS_src_define_define__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/src/define/define */ "./libs/LISS/V3/src/define/define.ts");
/* harmony import */ var _LISS_src__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @LISS/src */ "./libs/LISS/V3/src/index.ts");
/* harmony import */ var _LISS_src_ContentGenerators_AutoContentGenerator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @LISS/src/ContentGenerators/AutoContentGenerator */ "./libs/LISS/V3/src/ContentGenerators/AutoContentGenerator.ts");
/* harmony import */ var _LISS_src_utils_DOM_isPageLoaded__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @LISS/src/utils/DOM/isPageLoaded */ "./libs/LISS/V3/src/utils/DOM/isPageLoaded.ts");
/* harmony import */ var _LISS_src_utils_DOM_whenPageLoaded__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @LISS/src/utils/DOM/whenPageLoaded */ "./libs/LISS/V3/src/utils/DOM/whenPageLoaded.ts");
/* harmony import */ var _LISS_src_utils_network_fetchText__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @LISS/src/utils/network/fetchText */ "./libs/LISS/V3/src/utils/network/fetchText.ts");
/* harmony import */ var _LISS_src_utils_execute__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @LISS/src/utils/execute */ "./libs/LISS/V3/src/utils/execute/index.ts");
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_LISS_src__WEBPACK_IMPORTED_MODULE_1__]);
_LISS_src__WEBPACK_IMPORTED_MODULE_1__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
const script = document.querySelector('script:is([liss-auto],[liss-cdir],[liss-sw],[liss-files])');
function parseLISSFiles(files) {
    if (!files) return [
        "js",
        "bry",
        "html+css"
...
const LISS_FILES = parseLISSFiles(script?.getAttribute('liss-files'));
...
if (LISS_MODE === "auto-load" && DEFAULT_CDIR !== null) {
    if (!(0,_LISS_src_utils_DOM_isPageLoaded__WEBPACK_IMPORTED_MODULE_3__["default"])()) await (0,_LISS_src_utils_DOM_whenPageLoaded__WEBPACK_IMPORTED_MODULE_4__["default"])();
...
function autoload(cdir) {
    ...
    async function addTag(tag) {
        ...
        if (_LISS_src_define_define__WEBPACK_IMPORTED_MODULE_0__.WaitingDefine.has(tagname) || customElements.get(tagname) !== undefined) return;
...
async function tryFile(compo_dir, ext, target) {
    // special value...
    if (ext === "html+css") {
        const promises = [
            (0,_LISS_src_utils_network_fetchText__WEBPACK_IMPORTED_MODULE_5__["default"])(`${compo_dir}index.html`, true),
            (0,_LISS_src_utils_network_fetchText__WEBPACK_IMPORTED_MODULE_5__["default"])(`${compo_dir}index.css`, true)
        ];
        let result = await Promise.all(promises);
        if (result[0] === undefined) return false;
        target["html"] = result[0];
        if (result[1] !== undefined) target["css"] = result[1];
        return true;
    }
    const result = await (0,_LISS_src_utils_network_fetchText__WEBPACK_IMPORTED_MODULE_5__["default"])(`${compo_dir}index.${ext}`, true);
    if (result === undefined) return false;
    target[ext] = result;
    return true;
}
async function loadComponent(tagname, { cdir = DEFAULT_CDIR } = {}) {
    _LISS_src_define_define__WEBPACK_IMPORTED_MODULE_0__.WaitingDefine.add(tagname);
    // @ts-ignore
    let true_tagdir = globalThis.LISSContext?.override_tags?.[tagname] ?? tagname;
    const compo_dir = `${cdir}${true_tagdir}/`;
    const files = {};
    let found = false;
    for (let file of LISS_FILES)if (found = await tryFile(compo_dir, file, files)) break;
    if (!found) throw new Error(`No files found for webcomponent ${tagname}`);
...
async function defineWebComponent(tagname, files, origin) {
    let klass;
    if (files["js"] !== undefined) klass = (await (0,_LISS_src_utils_execute__WEBPACK_IMPORTED_MODULE_6__["default"])(files["js"], "js", origin)).default;
    if (files["bry"] !== undefined) klass = (await (0,_LISS_src_utils_execute__WEBPACK_IMPORTED_MODULE_6__["default"])(files["bry"], "bry", origin)).default;
    if (klass === undefined) klass = (0,_LISS_src__WEBPACK_IMPORTED_MODULE_1__["default"])({
        content_generator: _LISS_src_ContentGenerators_AutoContentGenerator__WEBPACK_IMPORTED_MODULE_2__["default"],
        ...files
    });
    (0,_LISS_src_define_define__WEBPACK_IMPORTED_MODULE_0__["default"])(tagname, klass);
    return klass;
}
...
/***/ "./libs/LISS/V3/src/define/define.ts":
/*!*******************************************!*\
  !*** ./libs/LISS/V3/src/define/define.ts ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _whenDefined__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./whenDefined */ "./libs/LISS/V3/src/define/whenDefined.ts");
/* harmony import */ var _LISS_src_LISS__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @LISS/src/LISS */ "./libs/LISS/V3/src/LISS.ts");

const WaitingDefine = new Set();
async function define(tagname, Klass) {
    if ("$is_class" in Klass) Klass = WrapPythonClass(Klass);
    //TODO: type safe
...
function WrapPythonClass(Klass) {
    const JSKlass = Klass.__bases__.filter((e)=>e.__name__ === "Wrapper")[0]._js_klass.$js_func;
    // @ts-ignore
    ...
    return class _Wrapper extends JSKlass {
        ...
        constructor(bry = null){
            super();
            if (bry === null) {
                // @ts-ignore
                globalThis.brython_wrapper_js = this;
                // @ts-ignore
                bry = __BRYTHON__.$call(Klass, [
                    0,
                    0,
                    0
                ])();
        ...
        }*/ static observedAttributes = Klass["observedAttributes"];
...
_LISS_src_LISS__WEBPACK_IMPORTED_MODULE_1__["default"].define = define;


/***/ }),

/***/ "./libs/LISS/V3/src/define/index.ts":
/*!******************************************!*\
  !*** ./libs/LISS/V3/src/define/index.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _define__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./define */ "./libs/LISS/V3/src/define/define.ts");
/* harmony import */ var _isDefined__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./isDefined */ "./libs/LISS/V3/src/define/isDefined.ts");
/* harmony import */ var _whenDefined__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./whenDefined */ "./libs/LISS/V3/src/define/whenDefined.ts");
/* harmony import */ var _LISS_src_LISS__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @LISS/src/LISS */ "./libs/LISS/V3/src/LISS.ts");




_LISS_src_LISS__WEBPACK_IMPORTED_MODULE_3__["default"].define = _define__WEBPACK_IMPORTED_MODULE_0__["default"];
_LISS_src_LISS__WEBPACK_IMPORTED_MODULE_3__["default"].isDefined = _isDefined__WEBPACK_IMPORTED_MODULE_1__["default"];
_LISS_src_LISS__WEBPACK_IMPORTED_MODULE_3__["default"].whenDefined = _whenDefined__WEBPACK_IMPORTED_MODULE_2__["default"];



/***/ }),

/***/ "./libs/LISS/V3/src/define/isDefined.ts":
/*!**********************************************!*\
  !*** ./libs/LISS/V3/src/define/isDefined.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/src/define/whenDefined.ts":
/*!************************************************!*\
  !*** ./libs/LISS/V3/src/define/whenDefined.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _LISS_src_LISS__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/src/LISS */ "./libs/LISS/V3/src/LISS.ts");
/* harmony import */ var _LISS_src_define__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @LISS/src/define */ "./libs/LISS/V3/src/define/index.ts");
/* harmony import */ var _LISS_src_define_autoload__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @LISS/src/define/autoload */ "./libs/LISS/V3/src/define/autoload.ts");
/* harmony import */ var _LISS_src_utils_parsers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @LISS/src/utils/parsers */ "./libs/LISS/V3/src/utils/parsers/index.ts");
/* harmony import */ var _LISS_src_utils_network_require__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @LISS/src/utils/network/require */ "./libs/LISS/V3/src/utils/network/require.ts");
/* harmony import */ var _LISS_src_utils_tests_assertElement__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @LISS/src/utils/tests/assertElement */ "./libs/LISS/V3/src/utils/tests/assertElement.ts");
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_LISS_src_define_autoload__WEBPACK_IMPORTED_MODULE_2__]);
_LISS_src_define_autoload__WEBPACK_IMPORTED_MODULE_2__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
_LISS_src_LISS__WEBPACK_IMPORTED_MODULE_0__["default"].VERSION = "V3";
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_LISS_src_LISS__WEBPACK_IMPORTED_MODULE_0__["default"]);
// @ts-ignore
globalThis.LISS = _LISS_src_LISS__WEBPACK_IMPORTED_MODULE_0__["default"];
...
/***/ "./libs/LISS/V3/src/signals/IndirectSignal.ts":
/*!****************************************************!*\
  !*** ./libs/LISS/V3/src/signals/IndirectSignal.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _ROSignal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ROSignal */ "./libs/LISS/V3/src/signals/ROSignal.ts");
...
/***/ "./libs/LISS/V3/src/signals/ROSignal.ts":
/*!**********************************************!*\
  !*** ./libs/LISS/V3/src/signals/ROSignal.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _SignalEvent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SignalEvent */ "./libs/LISS/V3/src/signals/SignalEvent.ts");
...
/***/ "./libs/LISS/V3/src/signals/Signal.ts":
/*!********************************************!*\
  !*** ./libs/LISS/V3/src/signals/Signal.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _IndirectSignal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./IndirectSignal */ "./libs/LISS/V3/src/signals/IndirectSignal.ts");
...
/***/ "./libs/LISS/V3/src/signals/SignalEvent.ts":
/*!*************************************************!*\
  !*** ./libs/LISS/V3/src/signals/SignalEvent.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class SignalEvent {
    ...
    unlisten(callback) {
        ...
        if (idx !== this.#callbacks.length - 1) this.#callbacks[idx] = this.#callbacks[this.#callbacks.length - 1];
        --this.#callbacks.length;
        return this;
    }
    trigger() {
        for(let i = 0; i < this.#callbacks.length; ++i)this.#callbacks[i](this);
        return this;
    }
}
...
/***/ "./libs/LISS/V3/src/utils/DOM/getPropertyInitialValue.ts":
/*!***************************************************************!*\
  !*** ./libs/LISS/V3/src/utils/DOM/getPropertyInitialValue.ts ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/src/utils/DOM/isDOMContentLoaded.ts":
/*!**********************************************************!*\
  !*** ./libs/LISS/V3/src/utils/DOM/isDOMContentLoaded.ts ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/src/utils/DOM/isPageLoaded.ts":
/*!****************************************************!*\
  !*** ./libs/LISS/V3/src/utils/DOM/isPageLoaded.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/src/utils/DOM/whenDOMContentLoaded.ts":
/*!************************************************************!*\
  !*** ./libs/LISS/V3/src/utils/DOM/whenDOMContentLoaded.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _isDOMContentLoaded__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./isDOMContentLoaded */ "./libs/LISS/V3/src/utils/DOM/isDOMContentLoaded.ts");
...
/***/ "./libs/LISS/V3/src/utils/DOM/whenPageLoaded.ts":
/*!******************************************************!*\
  !*** ./libs/LISS/V3/src/utils/DOM/whenPageLoaded.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (/* binding */ whenDOMContentLoaded)
/* harmony export */ });
/* harmony import */ var _isPageLoaded__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./isPageLoaded */ "./libs/LISS/V3/src/utils/DOM/isPageLoaded.ts");
...
/***/ "./libs/LISS/V3/src/utils/encode.ts":
/*!******************************************!*\
  !*** ./libs/LISS/V3/src/utils/encode.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/src/utils/execute/bry.ts":
/*!***********************************************!*\
  !*** ./libs/LISS/V3/src/utils/execute/bry.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ executeBry)
/* harmony export */ });
/* harmony import */ var _js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js */ "./libs/LISS/V3/src/utils/execute/js.ts");
...
async function executeBry(code, origin) {
    if (!wrapper_loaded) {
        await (0,_js__WEBPACK_IMPORTED_MODULE_0__["default"])(`globalThis.__BRYTHON__.runPythonSource(\`${bry_wrapper}\`, "_")`);
        wrapper_loaded = true;
    }
...
export default module.DefaultExport;`;
    return await (0,_js__WEBPACK_IMPORTED_MODULE_0__["default"])(jscode, origin);
}


/***/ }),

/***/ "./libs/LISS/V3/src/utils/execute/index.ts":
/*!*************************************************!*\
  !*** ./libs/LISS/V3/src/utils/execute/index.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _bry__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bry */ "./libs/LISS/V3/src/utils/execute/bry.ts");
/* harmony import */ var _js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js */ "./libs/LISS/V3/src/utils/execute/js.ts");


const EXEC = {
    js: _js__WEBPACK_IMPORTED_MODULE_1__["default"],
    bry: _bry__WEBPACK_IMPORTED_MODULE_0__["default"]
};
async function execute(code, type, origin) {
    return await EXEC[type](code, origin);
}


/***/ }),

/***/ "./libs/LISS/V3/src/utils/execute/js.ts":
/*!**********************************************!*\
  !*** ./libs/LISS/V3/src/utils/execute/js.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/src/utils/network/fetchText.ts":
/*!*****************************************************!*\
  !*** ./libs/LISS/V3/src/utils/network/fetchText.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/src/utils/network/require.ts":
/*!***************************************************!*\
  !*** ./libs/LISS/V3/src/utils/network/require.ts ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _fetchText__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fetchText */ "./libs/LISS/V3/src/utils/network/fetchText.ts");
...
/***/ "./libs/LISS/V3/src/utils/network/ressource.ts":
/*!*****************************************************!*\
  !*** ./libs/LISS/V3/src/utils/network/ressource.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/src/utils/parsers/html.ts":
/*!************************************************!*\
  !*** ./libs/LISS/V3/src/utils/parsers/html.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _isTemplateString__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./isTemplateString */ "./libs/LISS/V3/src/utils/parsers/isTemplateString.ts");
...
/***/ "./libs/LISS/V3/src/utils/parsers/index.ts":
/*!*************************************************!*\
  !*** ./libs/LISS/V3/src/utils/parsers/index.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _LISS_src_LISS__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/src/LISS */ "./libs/LISS/V3/src/LISS.ts");
/* harmony import */ var _html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./html */ "./libs/LISS/V3/src/utils/parsers/html.ts");
/* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./template */ "./libs/LISS/V3/src/utils/parsers/template.ts");
/* harmony import */ var _style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style */ "./libs/LISS/V3/src/utils/parsers/style.ts");




_LISS_src_LISS__WEBPACK_IMPORTED_MODULE_0__["default"].style = _style__WEBPACK_IMPORTED_MODULE_3__["default"];
_LISS_src_LISS__WEBPACK_IMPORTED_MODULE_0__["default"].template = _template__WEBPACK_IMPORTED_MODULE_2__["default"];
_LISS_src_LISS__WEBPACK_IMPORTED_MODULE_0__["default"].html = _html__WEBPACK_IMPORTED_MODULE_1__["default"];



/***/ }),

/***/ "./libs/LISS/V3/src/utils/parsers/isTemplateString.ts":
/*!************************************************************!*\
  !*** ./libs/LISS/V3/src/utils/parsers/isTemplateString.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/src/utils/parsers/style.ts":
/*!*************************************************!*\
  !*** ./libs/LISS/V3/src/utils/parsers/style.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/src/utils/parsers/template.ts":
/*!****************************************************!*\
  !*** ./libs/LISS/V3/src/utils/parsers/template.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./libs/LISS/V3/src/utils/tests/assertElement.ts":
/*!*******************************************************!*\
  !*** ./libs/LISS/V3/src/utils/tests/assertElement.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _LISS_src_define_whenDefined__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/src/define/whenDefined */ "./libs/LISS/V3/src/define/whenDefined.ts");
/* harmony import */ var _LISS_src_LISS__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @LISS/src/LISS */ "./libs/LISS/V3/src/LISS.ts");
...
async function assertElement(tagname, opts = {}) {
    ...
    const css = opts.css ?? {};
    await (0,_LISS_src_define_whenDefined__WEBPACK_IMPORTED_MODULE_0__["default"])(tagname);
    //for(let i = 0; i < 1; ++i)
    //    await waitFrame();
...
_LISS_src_LISS__WEBPACK_IMPORTED_MODULE_1__["default"].assertElement = assertElement;


/***/ }),

/***/ "./src/components/vshs-playground/index.ts":
/*!*************************************************!*\
  !*** ./src/components/vshs-playground/index.ts ***!
  \*************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _LISS_src___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/src/ */ "./libs/LISS/V3/src/index.ts");
/* harmony import */ var _LISS_components_playground_playground_area___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @LISS/components/playground/playground-area/ */ "./libs/LISS/V3/components/playground/playground-area/index.ts");
/* harmony import */ var _VSHS_utils_buildTestPage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @VSHS/utils/buildTestPage */ "./src/utils/buildTestPage.ts");
/* harmony import */ var _VSHS_utils_fakers_initializeFakers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @VSHS/utils/fakers/initializeFakers */ "./src/utils/fakers/initializeFakers.ts");
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_LISS_src___WEBPACK_IMPORTED_MODULE_0__, _LISS_components_playground_playground_area___WEBPACK_IMPORTED_MODULE_1__]);
([_LISS_src___WEBPACK_IMPORTED_MODULE_0__, _LISS_components_playground_playground_area___WEBPACK_IMPORTED_MODULE_1__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);




class VSHSPlayground extends _LISS_components_playground_playground_area___WEBPACK_IMPORTED_MODULE_1__["default"] {
    static observedAttributes = [
        ..._LISS_components_playground_playground_area___WEBPACK_IMPORTED_MODULE_1__["default"].observedAttributes,
        "server"
    ];
    generateIFrameContext() {
        let ext = ".js";
        ...
        return {
            initializeFakers: (0,_VSHS_utils_fakers_initializeFakers__WEBPACK_IMPORTED_MODULE_3__["default"])({
                code,
    ...
    generateIFrameContent() {
        ...
        if (use_server) handler_code.reset();
        return (0,_VSHS_utils_buildTestPage__WEBPACK_IMPORTED_MODULE_2__["default"])({
            codeLang: this.codeLang,
            js: this.codes["request.js"].getCode()
        });
    }
    static ASSETS_DIR = `/assets/examples/`;
    static RESSOURCES = [
        {
            file: 'index.js',
...
_LISS_src___WEBPACK_IMPORTED_MODULE_0__["default"].define('vshs-playground', VSHSPlayground);
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _LISS_pages_skeleton_base___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/pages/skeleton/base/ */ "./libs/LISS/V3/pages/skeleton/base/index.ts");
...
/* harmony import */ var _LISS_components_page_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @LISS/components/page/menu */ "./libs/LISS/V3/components/page/menu/index.ts");
/* harmony import */ var _raw_loader_src_pages_content_txt__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !!raw-loader!../../../../../../src/pages/content.txt */ "./node_modules/raw-loader/dist/cjs.js!./src/pages/content.txt");
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_LISS_pages_skeleton_base___WEBPACK_IMPORTED_MODULE_0__, _VSHS_components_vshs_playground___WEBPACK_IMPORTED_MODULE_1__]);
([_LISS_pages_skeleton_base___WEBPACK_IMPORTED_MODULE_0__, _VSHS_components_vshs_playground___WEBPACK_IMPORTED_MODULE_1__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);



// @ts-ignore

(0,_LISS_components_page_menu__WEBPACK_IMPORTED_MODULE_2__.initMenu)(_raw_loader_src_pages_content_txt__WEBPACK_IMPORTED_MODULE_3__["default"]);
...
function buildTestPage(args) {
    ...
    let js = args.js;
    if (args.codeLang === "bry") js = "request()";
    return `<!DOCTYPE html>
    <head>
        <style>
            body {
        ...
        ${args.codeLang === "bry" ? `<script type="text/javascript" src="${brython_script}"></script>` : ""}
        <script type="module">
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ fakeFetch)
/* harmony export */ });
/* harmony import */ var _VSHS_VSHS__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @VSHS/../VSHS */ "./VSHS.ts");

function fakeFetchServer(ctx, server, codeLang) {
    const _fetch = ctx.fetch;
    ctx.fetch = function(url, args = {}) {
        const headers = args.headers ?? {};
        args.headers = {
            ...headers,
            "use-brython": `${codeLang === "bry"}`
        };
        return _fetch(server + url, args);
    };
}
function fakeFetchNoServer(ctx, path) {
    ctx.fetch = async function(target, args) {
        const request = target instanceof Request ? target : new Request(target, args);
        const reg = (0,_VSHS_VSHS__WEBPACK_IMPORTED_MODULE_0__.path2regex)(path);
        const url = new URL(request.url);
        const uri = `${decodeURI(url.pathname)}/${request.method}`;
        const vars = (0,_VSHS_VSHS__WEBPACK_IMPORTED_MODULE_0__.match)(reg, uri);
        const route = {
            url,
            vars,
            path
        ...
        if (response === undefined) response = new Response();
        console.warn(response);
        if (!response.ok && response.headers.has("location")) response = new Response("Redirections not supported (use server in playground).", {
            status: 500,
            statusText: "Redirections not supported"
        });
        return response;
    };
}
function fakeFetch(ctx, server, codeLang, path) {
    if (server !== null) fakeFetchServer(ctx, server, codeLang);
    else fakeFetchNoServer(ctx, path);
}


/***/ }),

/***/ "./src/utils/fakers/fakeHandler.ts":
/*!*****************************************!*\
  !*** ./src/utils/fakers/fakeHandler.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ fakeHandler)
/* harmony export */ });
/* harmony import */ var _LISS_src_utils_execute__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/src/utils/execute */ "./libs/LISS/V3/src/utils/execute/index.ts");

async function fakeHandler(ctx, code, codeLang) {
    // @ts-ignore
    window.__BRYTHON__ = ctx.__BRYTHON__;
    // @ts-ignore
    const module = await (0,_LISS_src_utils_execute__WEBPACK_IMPORTED_MODULE_0__["default"])(code, codeLang);
    if (codeLang === "js") {
    ...
    ctx.handler = async (...args)=>{
        try {
            const r = await fct(...args);
            if (r?.__class__?.__qualname__ === "NoneType") return undefined;
            return r;
        } catch (e) {
            if (!("$py_error" in e)) throw e;
            let js_error = e.args[0];
            if (!(js_error instanceof Response)) js_error = new Error(js_error);
            throw js_error;
        }
    };
}
...
/***/ "./src/utils/fakers/initializeFakers.ts":
/*!**********************************************!*\
  !*** ./src/utils/fakers/initializeFakers.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ initializeFakers)
/* harmony export */ });
/* harmony import */ var _LISS_src_utils_execute__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @LISS/src/utils/execute */ "./libs/LISS/V3/src/utils/execute/index.ts");
/* harmony import */ var _fakeFetch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fakeFetch */ "./src/utils/fakers/fakeFetch.ts");
/* harmony import */ var _fakeHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fakeHandler */ "./src/utils/fakers/fakeHandler.ts");



function initializeFakers(args) {
    return async (ctx)=>{
        if (args.codeLang === "bry") {
            ctx.request = ()=>{
                // @ts-ignore
                (0,_LISS_src_utils_execute__WEBPACK_IMPORTED_MODULE_0__["default"])(args.request, "bry");
            };
        }
        await (0,_fakeHandler__WEBPACK_IMPORTED_MODULE_2__["default"])(ctx, args.code, args.codeLang);
        (0,_fakeFetch__WEBPACK_IMPORTED_MODULE_1__["default"])(ctx, args.server, args.codeLang, args.path);
        ctx.print_response = async (r)=>{
            ctx.document.body.textContent = `${r.status}: ${r.statusText}
...
/******/ __webpack_require__("./src/pages/skeleton/index.ts");
/******/ var __webpack_exports__ = __webpack_require__("./src/pages/skeleton/index.css");
/******/ 
